...
import {
  ...
  Settings, Bell, TrendingUp, Activity, Landmark
} from 'lucide-react';
...
const ADMIN_NAV: NavItem[] = [
  ...
  { href:'/admin/backups',    label:'Backups',            icon:<Database {...iconProps} /> },
];
      ...
      {!collapsed && (
        <div style={{ padding:'8px 14px', borderTop:`1px solid ${T.border}`, textAlign:'center' }}>
          <div style={{ fontSize:10, color:T.textMuted }}>
            Powered by <a href="https://www.idataone.com" target="_blank" rel="noopener noreferrer" style={{ color:T.primary, fontWeight:600, textDecoration:"none" }}>ஐDataOne</a>
          </div>
        </div>
      )}
    </div>
