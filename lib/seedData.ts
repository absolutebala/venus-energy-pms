...
export const DOC_STATUS: Record<string, Record<string, boolean>> = {
  'VE-2025-001': { safety_photos:true,  site_photos:true,  jmr_document:false, at_certificate:true,  noc_document:true,  drawing_document:true,  ptw_document:true  },
  'VE-2025-002': { safety_photos:true,  site_photos:true,  jmr_document:true,  at_certificate:true,  noc_document:true,  drawing_document:true,  ptw_document:true  },
  'VE-2025-003': { safety_photos:true,  site_photos:true,  jmr_document:true,  at_certificate:true,  noc_document:true,  drawing_document:true,  ptw_document:true  },
  'VE-2025-004': { safety_photos:true,  site_photos:false, jmr_document:false, at_certificate:true,  noc_document:false, drawing_document:true,  ptw_document:false },
  'VE-2025-005': { safety_photos:true,  site_photos:true,  jmr_document:false, at_certificate:false, noc_document:false, drawing_document:false, ptw_document:false },
  'VE-2025-006': { safety_photos:true,  site_photos:true,  jmr_document:true,  at_certificate:true,  noc_document:true,  drawing_document:true,  ptw_document:false },
  'VE-2025-007': { safety_photos:true,  site_photos:true,  jmr_document:false, at_certificate:true,  noc_document:true,  drawing_document:false, ptw_document:true  },
  'VE-2025-008': { safety_photos:false, site_photos:false, jmr_document:false, at_certificate:false, noc_document:false, drawing_document:false, ptw_document:false },
  'VE-2025-009': { safety_photos:true,  site_photos:false, jmr_document:false, at_certificate:true,  noc_document:false, drawing_document:true,  ptw_document:false },
  'VE-2025-010': { safety_photos:true,  site_photos:true,  jmr_document:true,  at_certificate:true,  noc_document:true,  drawing_document:true,  ptw_document:true  },
  'VE-2025-011': { safety_photos:true,  site_photos:true,  jmr_document:false, at_certificate:true,  noc_document:true,  drawing_document:false, ptw_document:false },
  'VE-2025-012': { safety_photos:true,  site_photos:false, jmr_document:false, at_certificate:false, noc_document:false, drawing_document:false, ptw_document:false },
  'VE-2025-013': { safety_photos:true,  site_photos:true,  jmr_document:true,  at_certificate:true,  noc_document:true,  drawing_document:true,  ptw_document:true  },
  'VE-2025-014': { safety_photos:true,  site_photos:true,  jmr_document:true,  at_certificate:true,  noc_document:false, drawing_document:true,  ptw_document:false },
  'VE-2025-015': { safety_photos:true,  site_photos:true,  jmr_document:false, at_certificate:true,  noc_document:true,  drawing_document:true,  ptw_document:true  },
};
