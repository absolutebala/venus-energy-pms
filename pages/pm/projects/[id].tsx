...
const PROJECTS: Record<string,any> = {
  ...
  'VE-2025-003': { id:'VE-2025-003', projectName:'Hyderabad Component Repl', site:'Hyderabad Central', pm:'Vijay Kumar', poNo:'PO-2025-003', poDate:'2025-04-10', poValue:760000, region:'Telangana', type:'Component Replacement', vendorAssigned:true, vendor:'TowerTech Pvt Ltd', vendorContact:'Arun Singh', vendorPhone:'+91 98765 43212', vendorEmail:'arun@towertech.com', vendorCompleted:true, returnLogisticsUnlocked:true },
  'VE-2025-007': { id:'VE-2025-007', projectName:'Mumbai Power Works',        site:'Mumbai Central',   pm:'Arun Kumar',  poNo:'PO-2025-007', poDate:'2025-04-05', poValue:890000, region:'Maharashtra', type:'Power Works', vendorAssigned:true, vendor:'PowerSys India', vendorContact:'Sunita Reddy', vendorPhone:'+91 98765 43215', vendorEmail:'sunita@powersys.com', vendorCompleted:true, returnLogisticsUnlocked:true },
  'VE-2025-009': { id:'VE-2025-009', projectName:'Kochi Component Delay',     site:'Kochi',            pm:'Vijay Kumar', poNo:'PO-2025-009', poDate:'2025-03-01', poValue:650000, region:'Kerala', type:'Component Replacement', vendorAssigned:false, vendor:'', vendorContact:'', vendorPhone:'', vendorEmail:'', vendorCompleted:false, returnLogisticsUnlocked:false },
  'VE-2025-010': { id:'VE-2025-010', projectName:'Kolkata Fiber Installation', site:'Kolkata North',    pm:'Arun Kumar',  poNo:'PO-2025-010', poDate:'2025-05-10', poValue:975000, region:'West Bengal', type:'Fiber Installation', vendorAssigned:false, vendor:'', vendorContact:'', vendorPhone:'', vendorEmail:'', vendorCompleted:false, returnLogisticsUnlocked:false },
};
