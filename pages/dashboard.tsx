...
const MOCK_UPDATED  = Object.fromEntries(SEED_DATA.map((p:any)=>[p.id,{date:new Date(p.startDate).toLocaleDateString('en-IN',{day:'2-digit',month:'short',year:'numeric'}),by:p.pm}]));
