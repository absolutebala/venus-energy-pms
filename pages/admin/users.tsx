...
const ROLES: UserRole[] = ['super_admin','management','region_manager','general_manager','project_manager','site_engineer','accounting_team','employee','vendor','viewer'];
...
const ADMIN_ASSIGNABLE_ROLES: UserRole[] = ['super_admin','management','region_manager','general_manager','project_manager','site_engineer','accounting_team','employee','vendor','viewer'];
