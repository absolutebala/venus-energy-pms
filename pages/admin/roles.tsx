...
const PROJECT_SECTIONS: { key: string; label: string; icon: string; desc: string }[] = [
  ...
  { key:'sec_po_items',  label:'STN Items',                icon:'📋', desc:'STN line items — Item Code, Description, UOM, Qty, Document No, BOQ Req No, Serial No, Tax Rate, Amount' },
  { key:'sec_ptw_detail',label:'PTW Section',               icon:'🔑', desc:'Permit to Work — Ticket ID, Supervisor Name, From/To Date, status indicator'    },
  { key:'sec_srn_detail', label:'SRN Section',              icon:'📦', desc:'Utilisation per STN item, Balance, Return Qty, SRN Raised/Received' },
  ...
  { key:'sec_expenses',  label:'Expenses Section',          icon:'💸', desc:'Expense requests per project — Date, Type, Amount, Remarks, Bank Account, UPI ID' },
...
const DEFAULT_SECTION_PERMS: Record<string, Record<string, Record<string, boolean>>> = {
  ...
  region_manager: {
    ...
    sec_po_items:          { can_read:true,  can_create:false, can_edit:true,  can_delete:false },
  ...
  project_manager: {
    ...
    sec_stn_srn:           { can_read:true,  can_create:false, can_edit:true,  can_delete:false },
    sec_billing_review:    { can_read:true,  can_create:false, can_edit:true,  can_delete:false },
    sec_po_items:          { can_read:true,  can_create:true,  can_edit:true,  can_delete:false },
    sec_ptw_detail:        { can_read:true,  can_create:true,  can_edit:true,  can_delete:false },
    sec_srn_detail:        { can_read:true,  can_create:false, can_edit:true,  can_delete:false },
    sec_expenses:          { can_read:true,  can_create:false, can_edit:false, can_delete:false },
    sec_stn_srn_summary:   { can_read:true,  can_create:false, can_edit:false, can_delete:false },
  ...
  site_engineer: {
    ...
    sec_po_items:          { can_read:true,  can_create:false, can_edit:false, can_delete:false },
  ...
  vendor: {
    ...
    sec_expenses:          { can_read:true,  can_create:true,  can_edit:true,  can_delete:false },
