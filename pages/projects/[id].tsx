...
const PROJECT_STATUS_OPTIONS = [
  ...
  'Works Completed / Docs Pending',
  'Works Completed / PO Pending',
  'JMS Pending with AE',
  'AT Certificate Pending',
  'PO Closed Work Not Done',
  'PO Closed without Billing',
  'Billing Shared',
  'Doc Not Received',
  'PO Amendment Done',
  'PO Amendment Validated',
  'WCC Raised',
  'WCC Rejected',
  'Invoice to be Submit / SRN Pending',
  'Invoice to be Submit / STN Pending',
  'Invoice to be Submit / CAM DOC Pending',
  ...
  const uploadStnPdf = async (file: File) => {
    ...
    try {
      ...
      setStnPdfItems(allExtracted.map((it:any) => ({
        ...
        boqReqNo: meta.boqReqNo||'', sno: it.sno||0,
